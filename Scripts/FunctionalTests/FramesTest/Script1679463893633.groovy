...
WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_Abstract Methods'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_org.openqa.selenium.bidi.log'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/li_Field'))

WebUI.click(findTestObject('Object Repository/Page_Capabilities/a_All Methods'))
